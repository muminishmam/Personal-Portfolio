...
const projects = [
  ...
  },
  {
    ...
    description:
      "A showcase of my skills and experiences, brought to life through the power of Next.js and Tailwind CSS. Meticulously crafted to reflect my expertise in building scalable, efficient, and user-friendly web applications. Designed to be visually appealing, highly performant, and responsive. Each component and section has been crafted with meticulous attention to detail, providing a seamless and engaging user experience across all devices.",
    image: "/portfolio.png",
